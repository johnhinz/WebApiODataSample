    ...
    public class SystemCountryCodeLogic 
    {
        ...
        private void Verify(SystemCountryCodePoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(900, "Code is required for SystemCountry "));
                }
                if (string.IsNullOrEmpty(poco.Name))
                {
                    exceptions.Add(new ValidationException(901, $"Name is required for SystemCountry {poco.Code}"));
                }
            }
